...
HTGStatusBar::HTGStatusBar(BRect frame)
	: BView(BRect(frame.left, frame.Height()+1-B_H_SCROLL_BAR_HEIGHT, frame.right-B_V_SCROLL_BAR_WIDTH, frame.Height()), "StatusBar", B_FOLLOW_LEFT_RIGHT | B_FOLLOW_BOTTOM,  B_WILL_DRAW | B_FULL_UPDATE_ON_RESIZE)
{
